...
# порядковый номер, принимать параметр количество цифр в порядковом номере.
# принимать параметр расширение исходного файла. Переименование должно работать только для этих 
# файлов внутри каталога, принимать параметр расширение конечного файла, принимать диапазон 
# сохраняемого оригинального имени. Например для диапазона [3, 6] берутся буквы с 3 по 6 из 
