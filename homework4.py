...
#print(diction(amigo='Jorge', amiga={'Monica': 2, 'Perez': 3}, tia=['Mariza', 'Sanches', 'Palacio'],
#                     tio={'Jose', 'Luis'}))


# Возьмите задачу о банкомате из семинара 2. Разбейте её 
# на отдельные операции — функции. Дополнительно сохраняйте все операции поступления и снятия 
#средств в список.
